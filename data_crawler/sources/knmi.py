...
class WeatherStationsKNMI(abstract_source.AbstractMultiMessageSourceAPI):
    ...
    def fetch_data_bundle(self, raw_data: Optional[io.BufferedReader] = None) -> Generator:
        """
        ...
        tmp_df = tmp_df.loc[tmp_df.index.get_level_values(0).isin(self.stations_to_save.values())] ## select rows (weather stations)
